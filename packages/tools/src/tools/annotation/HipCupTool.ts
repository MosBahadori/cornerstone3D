...
/**
 * HipCupTool let you draw annotations that measures the length of two drawing
 * points on a slice. You can use the HipCupTool in all imaging planes even in oblique
 ...
 *
 * toolGroup.setToolActive(HipCupTool.toolName, {
 *   bindings: [
 *    {
...
class HipCupTool extends AnnotationTool {
  static toolName;
...
HipCupTool.toolName = 'HipCup';
export default HipCupTool;
